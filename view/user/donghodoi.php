      ...
      <div class="container-fluid header" >
        <div class="container d-flex justify-content-between">
            ...
            <div class="d-flex align-items-center justify-content-between chiu">
                ...
                <div class="cart">
                    <a href="#1"><i class="fa-solid fa-cart-shopping fa-xl" style="color: #ffffff;"></i></a>
                </div>
...
<br>
    ...
    <div class="gallery">
        ...
        <div class="image-container1">
          ...
          <a href="#1"><img class="image" src="/img/tintuc1.jpg" alt="Image 1"></a>
          <a href="#1"><img class="image" src="/img/tintuc2.jpg" alt="Image 2"></a>
        </div>
    
        <div class="image-container2">
          
            <a href="#1"><img class="image" src="/img/thuonghieu1.jpg" alt="Image 3"></a>
            <a href="#1"><img class="image" src="/img/thuonghieu1.jpg" alt="Image 4"></a>
            <a href="#1"><img class="image" src="/img/thuonghieu1.jpg" alt="Image 5"></a>
            <a href="#1"><img class="image" src="/img/thuonghieu1.jpg" alt="Image 6"></a>
            <a href="#1"><img class="image" src="/img/thuonghieu1.jpg" alt="Image 7"></a>
        </div>
      </div>
    ...
    <div class="container d-flex ">
        <div class="row justify-content-center py-2 my-2">
            <div class="col-2 ">
                <a href="trangchitiet.html"><img src="img/dhdoi.webp" width="100%" alt="Ảnh sản phẩm" onmouseover="this.src='img/dhdoi.webp'" onmouseout="this.src='img/dhdoi.webp'">
                </a>
                <a href="trangchitiet.html"><p  class="text-center m-1">Đồng hồ nam Citizen Quartz</p></a>
                <p class="small text-center">AUTOMATIC</p>
                <a href="trangchitiet.html"><h4 class="">Giá: 6.456.000</h4></a>
            </div>
            <div class="col-2">
                <a href="trangchitiet.html"><img src="img/dhdoi.webp" width="100%" alt="Ảnh sản phẩm" onmouseover="this.src='img/dhdoi.webp'" onmouseout="this.src='img/dhdoi.webp'">
                <a href="trangchitiet.html"><p class="text-center m-1">Đồng hồ nam Citizen Quartz</p></a>
