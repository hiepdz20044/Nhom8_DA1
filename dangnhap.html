...
<style>
  .duongke{
    border-left: 2px solid #000; /* Định dạng đường thẳng và màu sắc */
      height: 400px; /* Chiều cao của đường thẳng */
      margin: 0 auto;
  }
</style>
...
<body>
    ...
    <div class="container d-flex justify-content-between ">
        <div class="col">
            ...
            <input type="text" placeholder="Email/SĐT" class="form-control"><br>
            <input type="text" placeholder="Mật khẩu" class="form-control">
            <div class="d-flex align-items-center">
                <input type="checkbox" name="" id="">
                <p class="m-1">Ghi nhớ mật khâủ</p>

            </div><br>
            <button class="btn btn-dark text-light btn-block p-3"
                style="border-top-right-radius: 25px; border-bottom-left-radius: 25px;">ĐĂNG NHẬP</button>

        </div ><div class="duongke m-4">        </div>
        <div class="col">
            <div class="row justify-content-center">
                <h2 class="">Khách hàng mới của DDH-08</h2>
                <div class="text-center"><p>Nếu bạn chưa có tài khoản trên ivymoda.com, hãy sử dụng tùy <br>chọn này để truy cập biểu mẫu đăng ký<div class="br"></div>

Bằng cách cung cấp cho IVY moda thông tin chi tiết của bạn,<br> quá trình mua hàng trên ivymoda.com sẽ là một trải nghiệm <br> thú vị và nhanh chóng hơn!</p></div>
<a href="dangky.html" style="border-top-right-radius: 25px; border-bottom-left-radius: 25px; " class=" btn-dark  btn-block text-decoration-none"><button class="btn btn-dark text-light btn-block p-3 "
