...
//  banner duoi
var images = [
  "./view/user/asset/image/bannerduoi1.jpg",
  "./view/user/asset/image/bannerduoi2.jpg",
  "./view/user/asset/image/bannerduoi3.jpg",
  "./view/user/asset/image/bannerduoi4.jpg",
  "./view/user/asset/image/bannerduoi5.jpg",
  "./view/user/asset/image/bannerduoi6.jpg",
  "./view/user/asset/image/bannerduoi7.jpg",
];
var currentIndex = 0;
