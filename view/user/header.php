      ...
      <div class="container d-flex justify-content-between">
          ...
          <div class="d-flex align-items-center justify-content-between chiu">
              ...
              <input type="text" name="kyw" placeholder="Tìm kiếm" >
                  <button name="timkiem"><i class="fa-solid fa-magnifying-glass fa-lg" style="color: #000000;"></i></button>
              </form>
              <div class="all_phone">
              ...
              <?php
                    if (!isset($_SESSION['sdt'])) {
                        ?>
                    <a href="index.php?type=dangnhap"><i class="fa-regular fa-user fa-xl" style="color: #ffffff;"></i></a>
              ...
              <div class="cart">
                  <a href="index.php?type=listCart"><i class="fa-solid fa-cart-shopping fa-xl" style="color: #ffffff;"></i></a>
